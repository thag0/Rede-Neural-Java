...
public class Treino{
   ...
   ArrayList<Float> historicoCusto = new ArrayList<>();
    ...
    */
   public void treino(RedeNeuralFloat rede, Otimizador otimizador, float[][] entradas, float[][] saidas, int epochs, boolean embaralhar){
      float[] dadosEntrada = new float[entradas[0].length];//tamanho de colunas da entrada
      float[] dadosSaida = new float[saidas[0].length];//tamanho de colunas da saída
    ...
    */
   public void treino(RedeNeuralFloat rede, Otimizador otimizador, float[][] entradas, float[][] saidas, int epochs, boolean embaralhar, int tamLote){
    ...
    */
   private void backpropagation(ArrayList<Camada> redec, float taxaAprendizagem, float[] saidas){
    ...
    * @param taxaAprendizagem valor de taxa de aprendizagem da rede neural.
    */
   private void calcularGradientes(ArrayList<Camada> redec, float taxaAprendizagem){
