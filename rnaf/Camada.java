...
import rnaf.ativacoes.ELU;
import rnaf.ativacoes.FuncaoAtivacao;
import rnaf.ativacoes.GELU;
import rnaf.ativacoes.LeakyReLU;
import rnaf.ativacoes.Linear;
import rnaf.ativacoes.ReLU;
import rnaf.ativacoes.Seno;
import rnaf.ativacoes.Sigmoid;
import rnaf.ativacoes.SoftPlus;
import rnaf.ativacoes.Swish;
import rnaf.ativacoes.TanH;
...
public class Camada implements Serializable{
    ...
    */
   public void inicializarNeuronios(int qNeuronios, int qLigacoes, float alcancePeso, int inicializador){
    ...
    */
   public float funcaoAtivacaoDx(float valor){
   ...
   private void argmax(){
      ...
      //aplicar argmax
      for(int i = 0; i < this.neuronios.length; i++){
         this.neuronios[i].saida = (i == indiceMaior) ? 1.0f : 0.0f;
      }
   }
   ...
   private void softmax(){
      ...
      for(Neuronio neuronio : this.neuronios){
         neuronio.saida = (float) (Math.exp(neuronio.somatorio) / somaExp);
      }
   }
